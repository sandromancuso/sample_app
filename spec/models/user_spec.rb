...
describe User do
  ...
  it "should rejet duplicated email addresses" do
  ...
  describe "password validations" do
    ...
    it "should require a matching password confirmation" do
      invalid_pwd_confirmation_user = User.new(@attr.merge(:password_confirmation => "invalid"))
      invalid_pwd_confirmation_user.should_not be_valid      
    end
